 ...
 */
final class Version20191025065637 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_stat ADD science_articles_count INT NOT NULL');
    }
