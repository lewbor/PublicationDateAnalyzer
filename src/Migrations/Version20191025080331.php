 ...
 */
final class Version20191025080331 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article_unpaywall_data (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, publisher_data JSON DEFAULT NULL, UNIQUE INDEX UNIQ_DF420B3B7294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE article_unpaywall_data ADD CONSTRAINT FK_DF420B3B7294869C FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE article_unpaywall_data');
