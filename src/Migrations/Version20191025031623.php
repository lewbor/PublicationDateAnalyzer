 ...
 */
final class Version20191025031623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_stat ADD wos_publication_types JSON NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_stat DROP wos_publication_types, CHANGE article_min_year article_min_year INT DEFAULT NULL, CHANGE article_max_year article_max_year INT DEFAULT NULL, CHANGE article_years article_years LONGTEXT NOT NULL COLLATE utf8mb4_bin');
