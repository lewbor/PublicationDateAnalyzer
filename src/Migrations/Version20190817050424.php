 ...
 */
final class Version20190817050424 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE unpaywall CHANGE doi doi VARCHAR(700) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE unpaywall CHANGE doi doi VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
