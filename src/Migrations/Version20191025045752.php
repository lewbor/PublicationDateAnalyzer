 ...
 */
final class Version20191025045752 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_analytics ADD options JSON NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_analytics DROP options, CHANGE analytics analytics LONGTEXT NOT NULL COLLATE utf8mb4_bin');
