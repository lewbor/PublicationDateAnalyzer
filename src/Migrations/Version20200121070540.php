 ...
 */
final class Version20200121070540 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_unpaywall_data ADD scrapped_at DATETIME DEFAULT NULL, ADD response_code INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_unpaywall_data DROP scrapped_at, DROP response_code, CHANGE publisher_data publisher_data LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`');
