 ...
 */
final class Version20191025081028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_unpaywall_data ADD open_access TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE article DROP open_access');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD open_access TINYINT(1) DEFAULT \'NULL\', CHANGE doi doi VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE article_unpaywall_data DROP open_access, CHANGE publisher_data publisher_data LONGTEXT DEFAULT NULL COLLATE utf8mb4_bin');
