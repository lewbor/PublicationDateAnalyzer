 ...
 */
final class Version20190817022313 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP unpaywall_data');
    }
