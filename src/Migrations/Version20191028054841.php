 ...
 */
final class Version20191028054841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE journal_wos_category (id INT AUTO_INCREMENT NOT NULL, journal_id INT NOT NULL, wos_category_id INT NOT NULL, INDEX IDX_E81C0931478E8802 (journal_id), INDEX IDX_E81C0931A0D714B7 (wos_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE journal_wos_category ADD CONSTRAINT FK_E81C0931478E8802 FOREIGN KEY (journal_id) REFERENCES journal (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE journal_wos_category ADD CONSTRAINT FK_E81C0931A0D714B7 FOREIGN KEY (wos_category_id) REFERENCES wos_category (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE journal_wos_category');
